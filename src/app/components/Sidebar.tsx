...
import { Timer, LayoutDashboard, Laptop } from 'lucide-react'
...
const Sidebar = (props: Props) => {
  return (
    <div id="menu" className="w-[400px] bg-gray-900 min-h-screen z-10 text-slate-300  left-0 h-screen overflow-y-scroll">
